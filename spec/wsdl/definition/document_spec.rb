...
describe WSDL::Definition::Document do
  ...
  describe '#services' do
    it 'works with multiple services' do
      ...
      expect(soap_port.type).to eq(WSDL::NS_SOAP_1_1)
    ...
    it 'only knows about the SOAP ports of each service' do
      ...
      expect(soap_1_1_port.type).to eq(WSDL::NS_SOAP_1_1)
