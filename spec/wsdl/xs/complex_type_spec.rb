...
describe WSDL::XS::ComplexType do
  ...
  specify 'complexContent/extension/sequence/element' do
    ...
    expect(sequence_elements[2]).to be_a(WSDL::XS::Element)
  ...
  specify 'complexType/sequence/element/simpleType' do
    ...
    expect(elements[2].inline_type).to be_a(WSDL::XS::SimpleType)
