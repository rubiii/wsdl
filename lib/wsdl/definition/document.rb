...
require 'wsdl/definition/service'
...
class WSDL
  class Definition
    ...
    class Document
      ...
      # @return [Hash<String, Message>] the messages defined in this document
      ...
      def imports
        ...
        @document.root.xpath('wsdl:import', 'wsdl' => WSDL::NS_WSDL).each do |node|
      ...
      def schema_nodes!
        ...
        types = root.at_xpath('wsdl:types', 'wsdl' => WSDL::NS_WSDL)
