...
require 'wsdl/http/config'
require 'wsdl/http/redirect_guard'

module WSDL
  module HTTP
    # HTTP client using Ruby's stdlib +net/http+.
    #
    # This is the default HTTP client used by {WSDL}. It provides a simple
    ...
    # == Redirect Security
    #
    # HTTP redirects are validated before following. The client blocks
    ...
    class Client
      ...
      #
      # This warning is logged once per client instance to avoid
